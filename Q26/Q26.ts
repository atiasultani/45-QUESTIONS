...
if (alien_color == "Green") {console.log("\n"),console.log("**** The Player Earned  5 Points ****")}
else if(alien_color == "Yellow"){ console.log("**** You Player Earned 10 Points ****") }
...
let alien_color2:string = "Brown";
if (alien_color2 == "Green") {console.log("\n"),console.log("**** The Player Earned  5 Points ****")}
else if(alien_color2 == "Yellow"){ console.log("**** You Player Earned 10 Points ****") }
