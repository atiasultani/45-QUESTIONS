...
let animals = ["Goat", "Cow", "Cat"];
for (let i = 0; i <= animals.length; i++) {
    if (animals[i] === "Goat") {
        console.log(`${animals[i]} : A Goat is great pet `);
    }
    else if (animals[i] === "Cow") {
        console.log(`${animals[i]} : A Cow could make pet.its economically help us to daily expenses of milk`);
    }
...
console.log("\n");
console.log(`These animals ${animals} have some common characteristics.
