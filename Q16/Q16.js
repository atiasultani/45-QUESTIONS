...
console.log("\n");
console.log(guest[0], " : i invite you to dinner today at  kababjees.Please join us .");
console.log(guest[1], " : i invite you to dinner today at  kababjees.Please join us .");
console.log(guest[2], " : i invite you to dinner today at  kababjees.Please join us .");
console.log("\n");
